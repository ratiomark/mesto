export const formElementEditProfile = document.querySelector('.popup_type_edit-profile').querySelector('form');
export const formElementAddNewCard = document.querySelector('.popup_type_new-card').querySelector('form');
export const formUpdateAvatar = document.querySelector('.popup_type_update-avatar').querySelector('form');
...
export const baseUrl = 'https://mesto.nomoreparties.co/v1/cohort-58'